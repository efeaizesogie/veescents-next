...
export default function StorePage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    result = result.filter(p => {
      const ngn = p.price * EXCHANGE_RATE;
      return ngn >= effectiveMinPrice && ngn <= effectiveMaxPrice;
    });
    const res = [...result];
    ...
    return res;
  }, [uniqueProducts, searchTerm, activeCategory, activeCat, activeSection, sortOption, minRating, newOnly, inStockOnly, activeBrands, effectiveMinPrice, effectiveMaxPrice]);
