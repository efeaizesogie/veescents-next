...
export default function ProductForm({
  ...
  product?: Product & { collection?: string; tags?: string[] };
}) {
  ...
  const ic =
    "w-full border border-gray-200 px-4 py-2.5 text-sm text-accent-dark focus:outline-none focus:border-accent-gold transition-colors bg-white rounded-sm";
  const lc =
    "block text-xs uppercase tracking-widest text-gray-400 font-medium mb-2";

  return (
    <form onSubmit={handleSubmit} className="max-w-2xl">
      {error && (
        <p className="mb-6 text-sm text-red-500 bg-red-50 px-4 py-3 rounded-sm">
          {error}
        </p>
      )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="col-span-2">
            ...
            <input
              ...
              placeholder="e.g. Armaf Club de Nuit"
            />
          </div>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-bold uppercase tracking-widest rounded-sm border transition-colors ${
                    form.tags.includes(tag)
                      ...
                      : "border-gray-200 text-gray-500 hover:border-accent-gold hover:text-accent-gold"
                  }`}
                >
                  {tag.replace("_", " ")}
                </button>
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label htmlFor="inStock" className="text-sm text-gray-500">
              In Stock
            </label>
          </div>
          <div className="flex items-center gap-3">
            <input
              ...
              className="accent-accent-gold w-4 h-4"
            />
            <label htmlFor="isNew" className="text-sm text-gray-500">
              New Arrival
            </label>
          </div>
