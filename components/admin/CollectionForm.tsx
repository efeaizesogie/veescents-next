...
export default function CollectionForm({
  ...
  collection?: CollectionData & { _id?: string };
}) {
  ...
  const set = <K extends keyof CollectionData>(
    field: K,
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="col-span-2">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (!collection) set("slug", autoSlug(e.target.value));
              }}
          ...
          <div className="col-span-2">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Used in URLs: /store?collection=
              <strong>{form.slug || "slug"}</strong>
            </p>
          </div>
