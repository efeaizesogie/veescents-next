...
export default function HomeProducts() {
  ...
  const initialProducts = newCollection.filter(
    (p) => p.isNew || p.isNewProduct
  );
  ...
  return (
    <>
      <section
        id="new-collection"
        className="py-20 container mx-auto px-6 scroll-mt-20"
        ref={sectionRef}
      >
      ...
      <section id="store" className="py-24 container mx-auto px-6 scroll-mt-20">
        <div className="text-center mb-12">
          <h2 className="font-serif text-4xl text-accent-dark">
            {gallerySectionName}
          </h2>
        </div>
